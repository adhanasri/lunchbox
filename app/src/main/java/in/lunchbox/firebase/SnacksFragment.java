...
/**
 * Fragment to maintain Snacks items on the Menu
 */
public class SnacksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView snacksListView = (RecyclerView) view.findViewById(R.id.mealsListView);

        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        snacksListView.setLayoutManager(layoutManager);
        ...
        snacksListView.setAdapter(menuItemRVAdapter);
        return view;
    }
    ...
    /**
     * Initialize the snacks items for the snacks fragment
     */
        ...
        menuRef.orderByChild("name").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : childrenSnapshots) {
                    ...
                    if (item.getType().equals(Constants.SNACKS_TYPE) && item.getStatus().equals(Constants.ENABLED)){
